...
import com.marn.task.databinding.FragmentShareBinding
import com.marn.task.domain.entity.Category
import com.marn.task.presentation.details.MealDetailsFragmentArgs
import com.marn.task.presentation.details.MealDetailsViewModel
...
class ShareFragment : Fragment() ,ClickHandler{
    ...
    private fun sendData() {
        ...
        outputStream?.write(category?.strCategory?.toByteArray())
